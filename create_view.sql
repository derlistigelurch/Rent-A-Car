...
FROM EXEMPLAR JOIN SCHAEDEN ON SCHAEDEN.SCHAEDEN_ID = EXEMPLAR.SCHAEDEN_ID
              JOIN AUTO_DETAILS ON AUTO_DETAILS.DETAIL_ID = EXEMPLAR.AUTO_DETAILS_ID
              JOIN HERSTELLER ON HERSTELLER.HERSTELLER_ID = AUTO_DETAILS.HERSTELLER_ID
              JOIN STANDORT ON STANDORT.STANDORT_ID = EXEMPLAR.STANDORT_ID;
...
AS
SELECT KUNDE.KUNDE_ID AS KUNDENNUMMER, PERSON.VORNAME, PERSON.NACHNAME, PERSON.GEBURTSDATUM, ADRESSE.STRASSE, ADRESSE.HAUSNUMMER, ADRESSE.TUERNUMMER, POSTLEITZAHL.PLZ, POSTLEITZAHL.ORTSNAME
